...
from support_func import update_rover, create_output_images
# Initialize socketio server and Flask application 
# (learn more at: https://python-socketio.readthedocs.io/en/latest/)
sio = socketio.Server()
app = Flask(__name__)

#df = pd.read_csv('C:/shwetapersonal/RoboticsSoftwareEnginner/dataset1/robot_log.csv', delimiter=';', decimal='.')
...
ground_truth = mpimg.imread('./cali_img/map_bw.png')
...
class RoverState():
    def __init__(self):
        ...
        self.rock_traced = False # To check if there is a rock seen in the image
        self.rocks_pos = None
        self.obs_pos = None
